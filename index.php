...
<head>
    <title>Nadia Schutz | Landing Page 5</title>
    <!--meta tags-->
    <meta charset="utf-8">
...
<body>
    <header>
        <nav>
            <div class="row">
                <img src="img/logo-white.png" alt="omnifoor logo" class="logo">
                <img src="img/logo.png" alt="omnifoor logo" class="logo-black">
                <ul class="main-nav js-main-nav">
                    <li><a href="#features" class="smooth-1">Food delivery</a></li>
                    <li><a href="#works" class="smooth-2">How it works</a></li>
                    <li><a href="#cities" class="smooth-3">Our cities</a></li>
                    <li><a href="#plans" class="smooth-4">Sign up</a></li>
                </ul>
